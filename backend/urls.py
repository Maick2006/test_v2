...
from actas.views import LoginView, ActaListCreateView, ActaDetailView, GestionCreateView, protected_media

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/login/', LoginView.as_view(), name='login'),
    path('api/actas/', ActaListCreateView.as_view(), name='actas-list-create'),
